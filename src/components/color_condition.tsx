...
abstract class ColorsCondtion {
    ...
    static condition = (side: string, type: string) => side === type ? ColorConstants.primaryColor
    : ColorConstants.primaryWhite;

    static textCondition = (side: string, type: string) => side === type ? ColorConstants.primaryColor
